                    ...
                    <div class="col-6 bg-light min-vh-100">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input name="item_name" type="text" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Input Name" value="{{ $items->item_name }}">
                            @error('item_name')
                            ...
                            <select name="category_name" id="category" class="form-control">
                                ...
                                @foreach ($data as $item)
                                    <option value="{{ $items->category }}"
                                        @if ($items->category_name === $item->category) selected @endif>
                                        {{ $items->category }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="item_price" class="form-control" id="price"
                                placeholder="Enter Price" value="{{ $items->price }}">
                            @error('item_price')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="editor" name="item_description">{{ $items->description }}</textarea>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="item_condition" id="ItemCondition" class="form-control">
                                ...
                                <option value="new" @if ($items->item_condition == 'new') selected @endif>New</option>
                                <option value="used" @if ($items->item_condition == 'used') selected @endif>Used</option>
                                <option value="second" @if ($items->item_condition == 'second') selected @endif>Good Second Hand
                                </option>
                            </select>
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <select name="item_type" id="ItemType" class="form-control">
                                ...
                                <option value="sell" @if ($items->item_type == 'sell') selected @endif>Sell</option>
                                <option value="buy" @if ($items->item_type == 'buy') selected @endif>Buy</option>
                                <option value="exchange" @if ($items->item_type == 'exchange') selected @endif>Exchange</option>
                            </select>
                        </div>
                        <div class="form-group mb-3">
                            <div>Status</div>
                            <input type="checkbox" class="form-check-input" id="exampleCheck1" name="item_status"
                                value="1" {{ $items->status == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <img src="{{ asset('storage/img/' . $items->item_photo) }}" width="50px" height="60px" />
                            @error('item_photo')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-6 bg-light min-vh-100">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="phone" type="tel" name="number" class="form-control"
                                value="{{ $items->contact_number }}" />
                        </div>
                        <div class="form-group mb-3">
                            <label for="address">Address</label>
                            <textarea class="form-control" id="address" name="address" value="{{ $items->address }}"></textarea>
                        </div>
                        <div class="form-group mb-3">
                            <div id="map" style="width: 100%;  height: 400px;"></div>
                        </div>
                        <a class="btn btn-light text-primary" href="javascript:history.back()">Cancel</a>
